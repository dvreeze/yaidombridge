...
/**
 * Simple document factories for yaidom from yaidom2 scoped documents.
 *
 * @author Chris de Vreeze
 */
object SimpleDocumentFactoryFromYaidom2 {
  ...
  def fromYaidom2Document(doc: yaidom2.queryapi.ScopedDocumentApi): yaidom.simple.Document = {
    ...
    new yaidom.simple.Document(doc.docUriOption, None, children)
  }
}
