...
object SimpleDocumentFactoryFromYaidom {
   ...
   */
  def fromYaidomDocument(doc: yaidom.queryapi.DocumentApi.Aux[_ <: yaidom.queryapi.ScopedNodes.Elem, _]): yaidom2.node.simple.Document = {
    val docElem: yaidom2.node.simple.Elem =
      SimpleNodeFactoryFromYaidom.fromYaidomScopedElem(doc.documentElement.asInstanceOf[yaidom.queryapi.ScopedNodes.Elem])
